...
public class PageRedirectSecurityFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if(role.getName().equals(RoleLogic.ROLE.DIRECTOR.toString())){
            req.setAttribute("role", role);
            req.getRequestDispatcher("/page/director/index.jsp")
                    .forward(req, res);
        }
        ...
        if(role.getName().equals(RoleLogic.ROLE.SELLER.toString())){
            req.setAttribute("role", role);
            req.getRequestDispatcher("/page/seller/index.jsp")
                    .forward(req, res);
        }
        if(role.getName().equals(RoleLogic.ROLE.CUSTOMER.toString())){
            req.setAttribute("role", role);
            req.getRequestDispatcher("/page/customer/index.jsp")
                    .forward(req, res);
        }
